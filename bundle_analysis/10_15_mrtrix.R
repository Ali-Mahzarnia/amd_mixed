...
data_path = '/Users/ali/Desktop/Mar23/amd_mixed/bundle_analysis/mrtrix_3/bundle_stats_withid/'
...
bundle_match_path = '/Users/ali/Desktop/Mar23/amd_mixed/bundle_analysis/mrtrix_6/ID_matcher/'
...
lm <- lmer( fa~AMD+ (1|Subject)  + Point.ID   ,data=msr_data, REML = TRUE)

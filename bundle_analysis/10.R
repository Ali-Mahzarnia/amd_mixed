...
data_path = '/Users/ali/Desktop/Mar23/amd_mixed/bundle_analysis/data2/bundle_stats_withid/'

msr_data_amd  = read.csv( paste0(data_path,'Initial_AMD_ctx-rh-lingual_right_to_left-cerebellum-cortex_left_all_bundle_stats.csv' ) )
msr_data_amd$AMD = 1 
msr_data_ctrl  = read.csv( paste0(data_path,'Initial_Control_ctx-rh-lingual_right_to_left-cerebellum-cortex_left_all_bundle_stats.csv' ) )
msr_data_ctrl$AMD = 0
...
bundle_match_path = '/Users/ali/Desktop/Mar23/amd_mixed/bundle_analysis/data2/ID_matcher/'
ID_matcher = read.csv( paste0(bundle_match_path,'Initial_ctx-rh-lingual_right_to_left-cerebellum-cortex_left_all_bundle_order.csv' ) )
...
dim(msr_data_bdl)/50
table(msr_data_bdl$Subject , msr_data_bdl$AMD)/50




lm <- lmer( md~AMD+ (1|Subject)  + Point.ID   ,data=msr_data_bdl, REML = TRUE)
